...
public class ConnectionPool {
	 ...
	 */
	private void setDataSource(String lookupName) {
		Context initCtx;
		try {
	 ...
	 * @throws NamingException 
	 */
	public ConnectionPool(String lookupName) throws ClassNotFoundException, SQLException {
		// 20130329.G.直接改用lookup方式去取得連線
		setDataSource(lookupName);
	}
