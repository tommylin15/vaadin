...
public class LongLatService {
    ...
    public static void main(String[] args) throws Exception {
        ...
        LatLon latlon= tDirectionService.getLongitudeLatitude("台北市內湖區堤頂大道二段257號");
    }
     
    public LatLon getLongitudeLatitude(String address) {
        ...
        try {
            ...
            try {
                ...
                //System.out.println(result.toString());//xml tag list
                ...
                latlon.setLat(Double.parseDouble(strLatitude));
                ...
                latlon.setLon(Double.parseDouble(strLongtitude));
