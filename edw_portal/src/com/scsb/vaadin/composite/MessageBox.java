...
public class MessageBox extends Window {
	...
	public static String GRID_DEFAULT_WIDTH1 = "300px";
	public static String GRID_DEFAULT_WIDTH2 = "260px";
	public static String DIALOG_DEFAULT_HEIGHT = "300px";
	public static String BUTTON_DEFAULT_WIDTH = "100px";
	public static Alignment BUTTON_DEFAULT_ALIGNMENT = Alignment.MIDDLE_RIGHT;
	public static String ICON_DEFAULT_SIZE = "24px";
	 ...
	 */
	public MessageBox(String dialogCaption ,String message){
		this( 
